...
do_cv <- function(mer_df, binary_ngrams)
  lapply(mer_df[["group"]], function(ith_group) 
    lapply(mer_df[["fold"]], function(ith_fold) {
...
do_cv_test <- function(mer_df, binary_ngrams)
  lapply(mer_df[["group"]], function(ith_group) 
    pblapply(mer_df[["fold"]], function(ith_fold) {
      train_dat <- filter(mer_df, group == ith_group, fold != ith_fold)
      test_dat <- filter(mer_df, group == ith_group, fold == ith_fold)
