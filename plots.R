...
plots_AmpGram <- drake_plan(neg = readd(negative_data),
                            ...
                            lactoferrin_mers_plot = get_lactoferrin_mers_plot(lactofferin_preds),
                            thrombin_preds = get_prot_preds("thrombin", c(597:622)),
                            thrombin_detailed_preds = get_detailed_preds(thrombin_preds),
                            thrombin_mers_plot = get_thrombin_mers_plot,
                            Nobles_benchmark_plot = readd(Nobles_datasets_benchmark_res),
